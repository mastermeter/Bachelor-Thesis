...
from congeo.dataset.cvusa import CVUSADatasetEval, CVUSADatasetTrain
from congeo.transforms import get_transforms_train, get_transforms_val
...
class Configuration:
    ...
    gps_dict_path: str = "/dataset/CVPR_subset/gps_dict.pkl"   # path to pre-computed distances
    ...
    # Dataset
    data_folder = "/dataset/CVPR_subset"     
