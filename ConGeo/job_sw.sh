#!/bin/bash
#SBATCH --job-name=congeo_swiss  # create a short name for your job
...
apptainer exec \
    --nv \
    --bind "/data/space/datasets/${USER_NAME}/swiss_dataset:/mnt/swiss_dataset" \
    ./version2.sif \
    python3 train_congeo_swiss.py